...
use App\Traits\CopyInteractsWithApi;
...
{
    use CopyInteractsWithApi;

    /**
     * @var string
     */
    protected $view = 'widgets.metrics.test-card';
     ...
     * @return $this
     */
    public function toolType(array $items)
    {
        $this->toolType = $items;
...
$('{$clickable}').on('click', function () {
    cc = $(this).parents('.dropdown').find('.btn').html($(this).text());
